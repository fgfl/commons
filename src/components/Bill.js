  ...
  return (
    <Card className={classes.root}>
      <CardHeader
        ...
        title="An Act to implement the Agreement between Canada, the United States of America and the United Mexican States"
        subheader="February 14, 2020"
      />
      <CardContent>
        <Typography variant="body2" color="textSecondary" component="p">
          This enactment implements the Agreement between Canada, the United
          States of America and the United Mexican States, done at Buenos Aires
          on November 30, 2018, as amended by the Protocol of Amendment to that
          Agreement, done at Mexico City on December 10, 2019.
        </Typography>
      </CardContent>
